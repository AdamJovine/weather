...
class PortfolioManager:
    ...
    def evaluate(
        ...
        buys  = self._evaluate_entries(markets, pred_rows, positions, bankroll, city_multipliers)
        return sells + buys
    ...
    def _evaluate_entries(
        ...
        for market in markets:
            ...
            # YES side — only if not already long yes and model is confident enough
            ...
            # NO side — only if not already long no and model is confident enough
